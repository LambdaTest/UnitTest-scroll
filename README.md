# Scroll in Python UnitTest with Selenium on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can test webpage scrolling behavior — including infinite scroll pages — as part of your cloud automation suite. This sample shows how to configure scrolling in Python UnitTest on the TestMu AI cloud.
...
To scroll to the bottom of the page, use the following line of code (refer to `scroll.py` for full code):
...
If you want **to scroll a page with infinite loading**, like social network pages (Facebook, etc.), use the following code (refer to `scroll.py` for full code):
